...
const AdminSidebar: React.FunctionComponent<IAdminSidebarProps> = (props) => {
  ...
  return (
    <div className="fixed left-0 w-[20%] h-screen bg-slate-300 flex flex-col gap-10 p-5 rounded-br-xl rounded-tr-xl py-40">
      ...
      <div className="w-full flex-col flex gap-10">
        ...
        >
          ...
          <div>
            <p className="text-xl">back to Dashboard</p>
          </div>
        </div>
      </div>
